...
enum UIStrings {
    ...
    static let appHelpPrivacy = String(localized: "Obfuskoder makes network connections only to check for updates, which you can disable in Settings. Saved values and settings are stored locally only.")
